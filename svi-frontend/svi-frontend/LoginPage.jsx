...
/**
 * SVI Login Page
 * Split layout: brand panel (grid-globe motif, echoing the SVI mark)
 * paired with a quiet, precise sign-in form.
 */
export default function LoginPage({ onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus("error");
      setErrorMsg(
        err?.message || "Couldn't sign you in. Check your details and try again."
      );
    }
  };
      ...
      <main className="svi-form-panel">
        <div className="svi-form-card">
          ...
          <p className="svi-form-card__footer">
            Need an account?{" "}
            <a href="#request-access" className="svi-link">
              Request access
            </a>
          </p>
        </div>
...
function EyeOffIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M10.6 5.2A9.9 9.9 0 0 1 12 5c6.4 0 10 7 10 7a16.7 16.7 0 0 1-3.5 4.3M6.6 6.6C4 8.3 2 12 2 12s3.6 7 10 7a9.7 9.7 0 0 0 4.4-1" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14.1 14.1a3 3 0 1 1-4.2-4.2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
