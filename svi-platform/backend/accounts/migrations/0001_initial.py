    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_no', models.CharField(help_text="'EN' in the wireframe — the SVI employee number", max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='mentee_photos/')),
                ...
                ('user', models.OneToOneField(limit_choices_to={'role': 'mentee'}, on_delete=django.db.models.deletion.CASCADE, related_name='mentee_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MentorProfile',
